                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right required">{{ __('Full Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="birth_date" class="col-md-4 col-form-label text-md-right required">{{ __('Date of Birth') }}</label>
                            <div class="col-md-6">
                                <input type="date" class="form-control" id="dob" name="birth_date"
                                  value="2010-01-01"
                                  min="1950-01-01" max="2021-01-31">
                              </div>
                        </div>

                        <div class="form-group row align-items-center">
                            <label for="gender" class="col-md-4 col-form-label text-md-right required">{{ __('Gender') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="user_address" class="col-md-4 col-form-label text-md-right required">{{ __('Address') }}</label>

                            <div class="col-md-6">
                                <textarea name="user_address" class="form-control @error('user_address') is-invalid @enderror" id="user_address" cols="30" rows="5"></textarea>
                                @error('user_address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="state" class="col-md-4 col-form-label text-md-right required">{{ __('State') }}</label>
